# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-catmap
#
...
release = aiida_catmap.__version__
...
html_use_opensearch = 'http://aiida-catmap.readthedocs.io'
...
htmlhelp_basename = 'aiida-catmap-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_catmap')
