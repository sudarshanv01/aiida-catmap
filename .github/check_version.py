...
Check version number in setup.json and aiida_catmap/__init__.py and make sure
they match.
"""
...
import aiida_catmap  # pylint: disable=wrong-import-position
version = aiida_catmap.__version__
